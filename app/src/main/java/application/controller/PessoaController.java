...
public class PessoaController {
    ...
    public Pessoa update(@PathVariable long id, @RequestBody Pessoa dadosNovos) {
        ...
        Pessoa dadosBancos = pessoaRepo.findById(id).get();
        dadosBancos.setNome(dadosNovos.getNome());
        dadosBancos.setIdade(dadosNovos.getIdade());

        return pessoaRepo.save(dadosBancos);
